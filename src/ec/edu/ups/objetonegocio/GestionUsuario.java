...
public class GestionUsuario {
    ...
    public List<String> buscarUsuario(String cedula) {
        ...
        if (oad.obtenerConexion()) {
            u = new Usuario();
            u = oad.buscarUsuario(cedula);
            oad.cerrarConexion();

        }

        List<String> usuariosRetornar = new ArrayList<>();
        usuariosRetornar.add("" + u.getIdUsuario());
        usuariosRetornar.add("" + u.getCedula());
        usuariosRetornar.add("" + u.getNombre());
        usuariosRetornar.add("" + u.getApellido());
        usuariosRetornar.add("" + u.getFechaNacimiento());
        usuariosRetornar.add("" + u.getGenero());
        usuariosRetornar.add("" + u.getEmail());
